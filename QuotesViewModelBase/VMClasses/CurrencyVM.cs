...
namespace QuotesViewModelBase.VMClasses
{
    ...
    public class CurrencyVM : BaseIdVM<CurrencyDto>, ICopy<ICurrencyVM>, ICurrencyVM, IEquatableValues<ICurrencyVM>, IEquatableValues<CurrencyDto>
    {
        ...
        /// <summary>Конструктор с передачей CurrencyKey</summary>
        /// <param name="currencyKey">Значение CurrencyKey</param>
        public CurrencyVM(string currencyKey) : base(currencyKey) { }

        /// <summary>Конструктор с передачей DTO типа</summary>
        /// <param name="other">Экземпляр DTO типа</param>
        public CurrencyVM(CurrencyDto dto) : base(dto) => CopyFromDTO(dto);
        ...
        public ICurrencyVM Copy() => (ICurrencyVM)MemberwiseClone();
        ...
        public void CopyTo(ICurrencyVM other)
        {
            CurrencyKey = other.CurrencyKey;
            ID = other.ID;
            NumCode = other.NumCode;
        ...
        public bool EqualValues(ICurrencyVM other)
